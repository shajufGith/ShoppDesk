                ...
                <>
                    ...
                    <div className="card">
                        ...
                        <div style={{ display: 'flex', gap: '0.5rem', marginBottom: '1rem' }}>
                            <input id="new-segment-input" className="form-input" placeholder="New segment name…" value={newSeg} onChange={e => setNewSeg(e.target.value)} onKeyDown={e => e.key === 'Enter' && addSegment()} style={{ flex: 1 }} />
